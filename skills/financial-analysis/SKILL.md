...
1. Write the markdown to `{{shared}}/workspace/generated/<TICKER>-<YYYY-MM-DD>.md`.
2. Convert to PDF with pandoc:

   ```bash
   pandoc {{shared}}/workspace/generated/<TICKER>-<DATE>.md \
     -o {{shared}}/workspace/generated/<TICKER>-<DATE>.pdf
   ```
3. Attach the PDF: `attach(path="{{shared}}/workspace/generated/<TICKER>-<DATE>.pdf")`.
