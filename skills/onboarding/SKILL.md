...
3. **Personality.** Run `load_skill` with `name=personality`. Follow it to completion — 2 questions, edits `context/identity.md`. The personality skill will also derive `### Voice` from the preferences answers earlier in this conversation.
