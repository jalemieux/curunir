...
**Inline vs. file path.** Default to inline. For very large inputs (>50KB or PDFs), write the content to `{{shared}}/workspace/scratch/input-<timestamp>.md` first and tell the sub-agent the path to read.
