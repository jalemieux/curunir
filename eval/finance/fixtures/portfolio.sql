...
INSERT INTO assets (class, label, account, qty, cost_basis, acquired, value) VALUES
  ('equity',      'VTI',                          'Taxable-2210',   800,  180000, '2021-03-15', 312000),
  ('equity',      'NVDA',                         'Taxable-2210',   300,   36000, '2023-06-01',  54000),
  ('cash',        'Cash',                         'Taxable-2210',  NULL,    NULL, NULL,          41000),
  ('equity',      'GLD',                          'Taxable-8890',   400,  120000, '2022-01-10', 168000),
  ('equity',      'AMZN',                         'Taxable-8890',   150,   24000, '2024-02-20',  31500),
  ('cash',        'Cash',                         'Taxable-8890',  NULL,    NULL, NULL,            600),
  ('equity',      'VTI',                          'IRA-5501',       500,  150000, '2020-05-05', 195000),
  ('equity',      'LLY',                          'IRA-5501',        60,   66000, '2025-11-01',  72000),
  ('cash',        'Cash',                         'IRA-5501',      NULL,    NULL, NULL,            500),
  ...
  ('equity',      'Blackstone Private Credit (BCRED)', 'AltAccount-3300', NULL, 12000, '2024-09-01', 12000),
  ('physical',    'Physical gold bullion',        'Home safe',        9,   31500, '2023-08-15',  40500),
  ('collectible', 'Rolex Daytona',                'Watch collection', 1,   22000, '2021-05-01',  28500),
  ('collectible', 'Omega Seamaster Aqua Terra',   'Watch collection', 1,    4200, '2022-03-01',   4700),
  ('collectible', 'Rolex GMT-Master II Batman',   'Watch collection', 1,   11800, '2022-09-01',  15800),
  ('collectible', 'Rolex GMT-Master II Pepsi',    'Watch collection', 1,   21000, '2020-11-01',  29500),
  ('collectible', 'Rolex Submariner Date',        'Watch collection', 1,    NULL, NULL,          12569),
  ('real_estate', 'Carolwood Dr (primary residence)', 'Real estate', NULL, 1900000, '2019-07-01', 3000000),
  ('real_estate', 'Paladin Dr (rental)',          'Real estate',   NULL,    NULL, NULL,        1400000);

INSERT INTO liabilities (label, balance, apr, type, property) VALUES
  ('Carolwood Dr mortgage', 1100000, 2.625, 'mortgage',  'Carolwood Dr (primary residence)'),
  ('Paladin Dr mortgage',    360000, 3.0,   'mortgage',  'Paladin Dr (rental)'),
  ('Line of Credit -7300',    95000, 7.5,   'unsecured', NULL);
