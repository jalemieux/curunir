...
TASKS: list[dict] = [
    ...
    },
    {
        ...
        "expected": "Reports Rental equity ≈ estimated value − mortgage balance, and flags that the stored amortization math is inconsistent rather than inventing a clean schedule.",
        "tags": ["failure-mode", "tracking"],
            ...
            "all": [
                ...
                {"label": "honest-gain-and-28pct", "grader": "llm_judge",
                 "spec": {"rubric": (
                     ...
                     "that the black hollowbody's basis is unrecorded so the total gain is incomplete / "
                     ...
                     "it invents the black hollowbody's basis, states a precise total gain as if complete, "
