...
TASKS: list[dict] = [
    ...
    },
    {
        ...
        "expected": "Reports Paladin equity ≈ Zestimate − mortgage balance, and flags that the stored amortization math is inconsistent rather than inventing a clean schedule.",
        "tags": ["failure-mode", "tracking"],
        "prompt": "What's my equity in the Paladin rental, and does the mortgage math look right?",
        "max_loops": 12,
        "grader": "composite",
        "spec": {
            "all": [
                ...
                {"label": "flags-amortization-discrepancy", "grader": "llm_judge",
                 "spec": {"rubric": (
                     "The stored note on the Paladin Dr mortgage is internally inconsistent: "
