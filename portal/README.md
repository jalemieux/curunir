...
The CLI prints the sign-in link directly (the portal does not send sign-in
email — links are surfaced in the logs / CLI output and in the admin UI).
...
- Create new users (the sign-in link is logged and shown in the UI to copy)
- Show / log a sign-in link
